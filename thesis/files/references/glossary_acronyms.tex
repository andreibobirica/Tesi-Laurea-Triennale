...
\newacronym{rtk}{RTK}{R T K}
\newglossaryentry{rtkg}{
    name={RTK},
    text={R T K},
    sort=rtk,
    description={//todo RTK Description}
}

\newglossaryentry{ddcserviceg}{
    name={DDC Service},
    sort=ddcservice,
    description={//todo DDC SERVICE Description}
}

\newglossaryentry{servicedoveng}{
    name={Serviced Oven},
    sort=servicedoven,
    description={//todo Serviced Oven Description}
}

\newglossaryentry{productcodeg}{
    name={Product Code},
    sort=productcode,
    description={//todo Product Code Description}
}

\newglossaryentry{firmwareg}{
    name={Firmware},
    sort=firmware,
    description={//todo Firmware Description}
}

\newglossaryentry{navbarg}{
    name={Nav Bar},
    sort=navbar,
    description={//todo Nav Bar Description}
}

\newglossaryentry{tabbarg}{
    name={Tab Bar},
    sort=tabbar,
    description={//todo Tab Bar Description}
}
...
\newglossaryentry{ecng}{
    name={ECN},
    sort=ecn,
    description={//todo ECN Description}
}
...
\newacronym{jwt}{JWT}{J W T}
\newglossaryentry{jwtg}{
    name={jwt},
    text={JWT},
    sort=jwt,
    description={In compus}
}
